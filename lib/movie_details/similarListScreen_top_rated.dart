...
class SimilarListScreenTopRated extends StatelessWidget{

  ResultsTopRated results ;
  SimilarListScreenTopRated({required this.results});

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<SimilarModel>(
      future: ApiFun.getSimilarListTopRated(results),
        builder: (context , asyncSnapShot) {
          ...
          return Column(
             ...
             Text(asyncSnapShot.error.toString() , style: TextStyle(color: Colors.white),) ,
              ElevatedButton(
              onPressed: (){
              ApiFun.getSimilarListTopRated(results);
                   },
